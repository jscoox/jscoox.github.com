(function(winObj) {
    ...
    function hideSearchAndFilters(){
        var hideFiltersOnScroll = new Headroom(CONST.filters),
            hideSearchOnScroll = new Headroom(CONST.stickySearch);
        ...
        function _enableBasedOnScreenSize(){
            if(CONST.window.innerWidth>849){
                hideSearchOnScroll.init();
                hideFiltersOnScroll.init();
            } else {
                if(hideFiltersOnScroll) hideFiltersOnScroll.destroy();
                if(hideSearchOnScroll) hideSearchOnScroll.destroy();
            }
        }
    }
